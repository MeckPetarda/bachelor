...
![Figure 3.3.1-2: Screenshot of the provisioning web form as rendered on a mobile device - showing WiFi SSID/password fields, MQTT broker IP/port fields, test buttons, and status display area](./images/3.3.1-2_page.png)
