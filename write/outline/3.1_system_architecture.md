...
| -------------------- | ---------------------------------- | ------------------------------------------------------------------- |
| Lighthouse unit (x2) | ESP32-WROOM-32 + YPD-R300          | Passive UHF RFID detection; raw scan publish via MQTT               |
...
LittleFS cache -> reconnect -> replay -> rejoin main path at raw_scans insert](./images/3.1-3_event_lifecycle.svg)
