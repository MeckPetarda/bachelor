...
| ---------------------- | ----------- | ------------- | ----------- | ------------ |
| Temporal Centroid (C₁) | `<PH>`      | `<PH>`        | `<PH>`      | `<PH>`       |
| RSSI-Weighted (C₂)     | `<PH>`      | `<PH>`        | `<PH>`      | `<PH>`       |
...
- Head-to-head comparison of Algorithm 1 (Temporal Centroid, C₁) and Algorithm 2 (RSSI-Weighted Centroid, C₂) on the
...
| Metric                          | C₁ Temporal | C₂ RSSI-Weighted |
| ------------------------------- | ----------- | ---------------- |
...
**[Figure 3.6.3-1: Scatter plot — C₁ confidence vs. C₂ confidence per traversal; colour-coded by correctness agreement
(both correct / disagree / both incorrect); diagonal reference line]**

- Cases where algorithms disagree: direction call differs between C₁ and C₂; analysed separately to understand when
