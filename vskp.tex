...
\autor{}{Jakub Hloušek}{}  % Jméno autora, 
...
\nazev{Embedded řešení docházkového systému pro integraci do podnikové aplikace} 
  % Ručně můžete dlouhý text zalomit pomocí " \break "
\ennazev{Embedded Implementation  of an Attendance System for Integration into an Enterprise Application} 
  % Ručně můžete dlouhý text zalomit pomocí " \break "

%vedouci prace
\vedouci{}{}{}
\citacevedouci{Vedoucí  .} % Označení vedoucího práce pro citaci záv. práce. Musí být ukončeno tečkou.
