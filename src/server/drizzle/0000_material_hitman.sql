...
ALTER TABLE "tag_assignments" ADD CONSTRAINT "tag_assignments_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_processed_events_tag_timestamp" ON "processed_events" USING btree ("tag_id","timestamp");--> statement-breakpoint
...
CREATE INDEX "idx_raw_scans_processed" ON "raw_scans" USING btree ("processed");--> statement-breakpoint
...
CREATE INDEX "idx_users_internal_id" ON "users" USING btree ("internal_id");--> statement-breakpoint
