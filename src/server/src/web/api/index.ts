...
export function claimDevice(
  ...
  return post<Lighthouse>(`/devices/pending/${encodeURIComponent(deviceId)}/claim`, data);
}
...
export function updateGroup(id: number, data: UpdateGroupRequest): Promise<Group> {
...
// Scans
export function getScans(filters: ScansFilter = {}): Promise<PaginatedResponse<Scan>> {
